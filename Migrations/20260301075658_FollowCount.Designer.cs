...
namespace Blog.Migrations
{
    ...
    [Migration("20260301075658_FollowCount")]
    partial class FollowCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Entities.User", b =>
                {
                    ...
                    b.Property<string>("AvatarOriginalUrl")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");

                    b.Property<string>("AvatarProfileUrl")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");

                    b.Property<string>("AvatarSmall32Url")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");

                    b.Property<string>("AvatarSmall40Url")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
            ...
            modelBuilder.Entity("Blog.Entities.Follower", b =>
                {
                    b.HasOne("Blog.Entities.User", "FollowerUser")
                        .WithMany()
                        .HasForeignKey("FollowerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blog.Entities.User", "Following")
                        .WithMany()
